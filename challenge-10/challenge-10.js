(function() {
  ...
  */
  function showOperationMessage(oper, n1, n2) {
    console.log(`A operação ${n1} ${oper} ${n2} = `);
  }
  ...
  */
  function showErrorMessage(oper) {
    if (!isOperatorValid(oper)) {
      console.log(`Operação ${oper} não permitida!`);
    };
  }
  ...
  */
  operationSignal = '$';
  const invalid = calculator(operationSignal);
  if ( invalid ) {
    number1 = 10;
    number2 = 12;
